...
@Tag(name = "08. File Management", description = "Storage, media attachments, and file uploads")
@RestController
...
public class FileController {
    ...
    @Operation(summary = "Get signed storage upload and download credentials for file attachments")
    @GetMapping("/credentials")
    public Map<String, Object> getFileCredentials(@RequestParam("filename") String filename, @RequestParam("storageId") String storageId) throws IOException, GeneralSecurityException, URISyntaxException {
